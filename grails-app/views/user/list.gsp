			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="middleInitial" title="${message(code: 'user.middleInitial.label', default: 'Middle Initial')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "middleInitial")}</td>
